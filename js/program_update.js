...
//////////////////////////////////////////////////////////////////////////////
    //dwoskrydlowka rozwierno-uchylne
        ...
        showDialog();
        document.querySelector('.title-dialog').innerText = 'Uwaga:  Niewłaściwy +++wybór typu okna!!!'
    }
...
function click_button_ER_2(params) {
    ...
    if (res1 == 1 && res2 == 0 && res3 == 0 && res4 == 1) {
        if (width !== '' && height !== '' && klamka !== '') {
            if (height >= 601 && height <= 2600 && width <= 1400) {
...
function zasuwnica_Er2(height, klamka) {
    if (height >= 601 && height <= 800 && klamka == 283) {
        ...
        document.getElementById('x-r-uch-zas').innerText = '700 1370 1121';
        document.getElementById('x-r-uch-nsp').innerText = '1121';
        check_box();
    }
...
function plecyXX_rozw_uch_Er2(height) {
    let res1 = fun1();
    let res2 = fun2();
    let res3 = fun3();
    let res4 = fun4();
